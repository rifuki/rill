//! Keyless simulation against a real fullnode.
//!
//! The assumption the whole design rests on: a server holding no key can ask whether a transaction
//! nobody has signed would execute. Documentation was not enough to settle it, so this asks a node.
//!
